	...
	public GridCoverage2D execute(
		...
		if (features != null) {
			...
			if (it.hasNext()) {
				...
				final DistributedRenderResult actualResult = (DistributedRenderResult) resultFeature.getAttribute(
						0);
				final DistributedRenderOptions renderOptions = (DistributedRenderOptions) resultFeature.getAttribute(
						1);
				...
				final BufferedImage result = actualResult.renderComposite(
						renderOptions);
